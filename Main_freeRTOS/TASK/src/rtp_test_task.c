            ...
            if (tp_dev.x[0] < lcddev.width && tp_dev.y[0] < lcddev.height) {
                if (tp_dev.x[0] > (lcddev.width - 24) && tp_dev.y[0] < 16)
                    Load_Drow_Dialog();  //���
                         ...
                         (tp_dev.y[0] < 165) && (tp_dev.y[0] > 113))  //����
                {
                    shiboqi_ch = 0;
                } else if ((tp_dev.x[0] > 34) && (tp_dev.x[0] < 72) &&
                           (tp_dev.y[0] < 165) && (tp_dev.y[0] > 117))  //����
                {
                    shiboqi_ch = 1;
                           ...
                           (tp_dev.y[0] < 311) && (tp_dev.y[0] > 238))  //����
                {
                    ...
                    // ,2357 ,     1667 ,1095 ,2381 ,     1500 ,1071 ,2429 , 1333
                    // ,1143 ,500,
